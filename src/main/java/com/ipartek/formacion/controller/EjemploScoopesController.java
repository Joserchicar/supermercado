...
/**
 * Servlet implementation class EjemploScoopesController
 */
@WebServlet("/EjemploScoopes")
public class EjemploScoopesController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		sc.setAttribute("usuarios_conectados","Aplicacion");
