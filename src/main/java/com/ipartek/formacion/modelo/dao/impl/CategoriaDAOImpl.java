...
public class CategoriaDAOImpl implements CategoriaDAO {
	...
	private final String PA_INSERT = " { CALL pa_categoria_crear(?,?) } ";
	private final String PA_UPDATE = " { CALL pa_categorias_update(?,?) } ";	
	private final String PA_DELETE = " { CALL pa_categorias_delete(?) } ";
