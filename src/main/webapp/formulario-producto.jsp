			...
			<form action="productos" method="post" class="form-producto">
				...
				<div class="form-group">
					<label for="nombre">Nombre:</label> <input type="text"
						class="form-control" value="${producto.nombre}" required autofocus
						placeholder="Nombre del producto" name="nombre" id="nombre">
				</div>

				<div class="form-group">
					<label for="precio">Precio:</label> <input type="text"
						class="form-control" value="${producto.precio}" required
						placeholder="0.0 € " name="precio" id="precio">
				</div>

				<div class="form-group">
					<label for="imagen">Imagen:</label> <input type="text"
						class="form-control" value="${producto.imagen}"
						placeholder="URL de la imagen" name="imagen" id="imagen">
				</div>
