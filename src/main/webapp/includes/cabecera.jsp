        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
           ...
           <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link ${ ( 'productos' eq param.pagina ) ? 'active' : '' } "  href="formulario-producto.jsp"> crear Productos</a>
            </li>           
        	<li class="nav-item">
              <a class="nav-link ${ ( 'productos' eq param.pagina ) ? 'active' : '' } "  href="productos">lista Productos</a>
            </li>           
